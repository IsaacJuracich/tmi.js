		...
		return new Promise(async function (resolve, reject) {
			request.get(
				...
				async (err, res, body) => {
					if (err) return err;
					const data = JSON.parse(res);
					return resolve(data.chatters.moderators);
				}
			);
		});
	},
		...
		return new Promise(async function (resolve, reject) {
			request.get(
				...
				async (err, res, body) => {
					if (err) return err;
					const data = JSON.parse(res);
					return resolve(data.chatters.vips);
				}
			);
		});
	},
		...
		return new Promise(async function (resolve, reject) {
			request.get(
				...
				async (err, res, body) => {
					if (err) return err;
					const data = JSON.parse(res);
					return resolve(data.chatters.admins);
				}
			);
		});
	},
		...
		return new Promise(async function (resolve, reject) {
			request.get(
				...
				async (err, res, body) => {
					if (err) return err;
					const data = JSON.parse(res);
					return resolve(data.chatters.staff);
				}
			);
		});
	},

	getGlobalMods(channel) {
		return new Promise(async function (resolve, reject) {
			request.get(
				"https://tmi.twitch.tv/group/user/" + channel + "/chatters",
				async (err, res, body) => {
					if (err) return err;
					const data = JSON.parse(res);
					return resolve(data.chatters.global_mods);
				}
			);
		});
	},
		...
		return new Promise(async function (resolve, reject) {
			request.get(
				...
				async (err, res, body) => {
					if (err) return err;
					const data = JSON.parse(res);
					return resolve(data.chatter_count);
				}
			);
		});
	},
